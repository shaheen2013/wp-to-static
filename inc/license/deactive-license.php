...
class Deactive_License extends Base_Ajax{
    ...
    protected function load_hooks(){
        add_action('wp_ajax_deactive_license', [$this, 'deactive_license']);
    }
    ...
    public function deactive_license(){
        ...
        try{
            ...
            if($response_body && $response_body['success']){
                ...
                $this->responseHandler->send_error_response('Failed to deactivate license');
            }
